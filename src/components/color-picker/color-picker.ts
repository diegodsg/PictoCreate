...
export class ColorPickerComponent {
  ...
  constructor(public viewCtrl: ViewController, public platform: Platform, public modalCtrl: ModalController) {
...
*/
    this.ctxPalette.canvas.width  = width;
    this.ctxPalette.canvas.height = height;
/*
...
this.ctxPalette.canvas.style.height = height + "px";
  ...
  initChooser(){
    ...
    console.log("Chooser w:"+width+", h: "+ height);
